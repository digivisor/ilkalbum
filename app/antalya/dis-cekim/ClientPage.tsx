...
import { Camera, MapPin, Sun, Trees, Mountain, Phone, CheckCircle, Heart, Users, Clock, Star, Calendar } from 'lucide-react';
          ...
          <div className="container relative z-10">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-playfair font-bold mb-6">
                Antalya Dış Çekim Fotoğrafçısı – Doğal Işık Çekimleri
              </h1>
