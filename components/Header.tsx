...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 glass-effect border-b border-pink-100">
        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center space-x-4 text-sm text-gray-600">
            <a 
              ...
              className="flex items-center space-x-1 hover:text-pink-600 transition-colors duration-200"
            >
              <Phone size={16} />
        ...
        {isMenuOpen && (
          <div className="lg:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-pink-100">
              ...
              <div className="px-3 py-2 border-t border-pink-100 mt-2">
                <a 
                  href="tel:+905457845667" 
                  className="flex items-center space-x-1 text-sm text-gray-600 mb-1 hover:text-pink-600 transition-colors duration-200"
                >
                  <Phone size={16} />
                  <span>+90 545 784 56 67</span>
                </a>
